...
if(isset($_POST['action']))
{
    ...
    mysql_query("UPDATE ilumi SET ilumi_on_h ='$hh_l' WHERE ilumi_id = 2");
    mysql_query("UPDATE ilumi SET ilumi_on_m ='$mm_l' WHERE ilumi_id = 2");
    mysql_query("UPDATE ilumi SET ilumi_off_h ='$hh_d' WHERE ilumi_id = 2");
    mysql_query("UPDATE ilumi SET ilumi_off_m ='$mm_d' WHERE ilumi_id = 2");
...
print'<br>
<form role="form" name="altera" action="kit_hora.php" method="post" id="altera" >
<div class="alert alert alert-info"><b> Setar novo intervalo para a Cozinha </b></div>
<div class="row">
