...
if(isset($_POST['action']))
{
    ...
    mysql_query("UPDATE ilumi SET ilumi_on_h ='$hh_l' WHERE ilumi_id = 1");
    mysql_query("UPDATE ilumi SET ilumi_on_m ='$mm_l' WHERE ilumi_id = 1");
    mysql_query("UPDATE ilumi SET ilumi_off_h ='$hh_d' WHERE ilumi_id = 1");
    mysql_query("UPDATE ilumi SET ilumi_off_m ='$mm_d' WHERE ilumi_id = 1");
...
<div class="panel-heading"><span class="label label-default" style="background-color: #fff;color:#000"> / Inicio / Iluminacao / Config / Auto &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span></div>
...
print'<br>
<form role="form" name="altera" action="bed_hora.php" method="post" id="altera" >
<div class="alert alert alert-info"><b> Setar novo intervalo para o Quarto </b> </div>
<div class="row">
